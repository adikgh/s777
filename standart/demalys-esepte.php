...
<div class="pop_bl fr4">
	...
	<div class="pop_bl_c">
		<div class="head_c txt_c"><h5>Рассчитайте свой отдых!</h5></div>
		<div class="form_c">
			...
			<div class="form_im">
				<p>Как долго вы планируете отдых?</p>
				<div class="form_kl">
			...
			<div class="form_im"><input type="tel" placeholder="+7 (___) ___-__-__" class="form_im_txt phone ms_phone" im-insert="true"></div>
